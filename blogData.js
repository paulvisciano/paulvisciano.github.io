window.blogPosts = [
  ...
  },
  {
    ...
    tags: ["hiking", "nature"],
    snippet: "Hiked Boulder’s scenic trails and enjoyed the laid-back vibe of Pearl Street.",
  ...
  {
    id: "post-san-diego-2",
    title: "San Diego’s Coastal Charm",
    date: new Date('2025-05-20T00:00:00Z'),
    timelineHighlight: "San Diego Beaches",
    tags: ["beach", "surfing"],
    snippet: "Back to San Diego for more surfing and sunset strolls along the coast.",
    image: "attachment://placeholder-san-diego.jpg",
    imageAlt: "San Diego Sunset",
    caption: "San Diego’s coastal sunset vibes!",
    mapLink: "https://maps.app.goo.gl/placeholder",
    mapText: "📍 Find San Diego on Google Maps",
    fullLink: "#",
    location: { lat: 32.7157, lng: -117.1611, name: "San Diego, California" },
  ...
  },
  {
    ...
    title: "Miami Beach Summer Vibes",
    date: new Date('2025-05-21T00:00:00Z'),
    timelineHighlight: "Miami Beach Summer",
    tags: ["beach", "nightlife"],
    snippet: "Summer in Miami Beach with sunny beaches and electrifying nightlife.",
    image: "attachment://placeholder-miami-beach.jpg",
    imageAlt: "Miami Beach Summer",
    caption: "Summer nights in Miami Beach!",
    mapLink: "https://maps.app.goo.gl/placeholder",
    mapText: "📍 Find Miami Beach on Google Maps",
    fullLink: "#",
    location: { lat: 25.7907, lng: -80.1300, name: "Miami Beach, Florida" },
  ...
  {
    id: "post-san-diego-3",
    title: "More San Diego Surf",
    date: new Date('2025-05-28T00:00:00Z'),
    timelineHighlight: "San Diego Surf",
    tags: ["beach", "surfing"],
    snippet: "Returned to San Diego for more waves and coastal relaxation.",
    image: "attachment://placeholder-san-diego.jpg",
    imageAlt: "San Diego Surf",
    caption: "Catching waves in San Diego!",
    mapLink: "https://maps.app.goo.gl/placeholder",
    mapText: "📍 Find San Diego on Google Maps",
    fullLink: "#",
    location: { lat: 32.7157, lng: -117.1611, name: "San Diego, California" },
  ...
  {
    id: "post-oahu",
    title: "Oahu’s Island Adventures",
    date: new Date('2025-06-15T00:00:00Z'),
    timelineHighlight: "Oahu Beaches",
    tags: ["beach", "nature"],
    snippet: "Explored Oahu’s stunning beaches, hiked volcanic trails, and embraced island life.",
    image: "attachment://placeholder-oahu.jpg",
    imageAlt: "Oahu Beach",
    caption: "Oahu’s North Shore waves!",
    mapLink: "https://maps.app.goo.gl/placeholder",
