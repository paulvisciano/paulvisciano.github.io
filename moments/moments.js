...
window.momentsInTime = [
  ...
  },
  {
    ...
    snippet: "Post-wedding Miami reunion with the volleyball crew! Catching up with the team, training on South Beach, and soaking up the vibrant energy with the squad before flying to Lisbon for the work retreat.",
    fullLink: "#",
    location: { lat: 25.7617, lng: -80.1918, name: "Miami, Florida" },
    stayDuration: 7,
    formattedDuration: formatDuration(7)
  },
  {
    ...
    title: "St. Petersburg Art & Beach Week",
    date: new Date('2025-10-20T00:00:00Z'),
    timelineHighlight: "St. Pete Vibes",
    tags: ["family", "friends", "st petersburg", "florida", "relaxation", "reunion", "zacharias", "volleyball planning"],
    snippet: "Heartwarming week in St. Petersburg catching up with friends and family after the intense Lisbon work trip. Quality time with loved ones, exploring familiar spots, and meeting up with Zacharias to plan our Mexico tournament strategy before heading south together.",
    fullLink: "#",
    location: { lat: 27.7676, lng: -82.6403, name: "St. Petersburg, Florida" },
    stayDuration: 8,
    formattedDuration: formatDuration(8)
  ...
  },
  {
    ...
    snippet: "After missing the Fuds volleyball tournament due to the Lisbon work trip, finally teaming up with Zacharias for our Mexico beach volleyball tournament! Coming together from St. Pete, arriving early in the week to prep and enjoy Playa before the tournament (Fri Oct 31 - Sun Nov 2). This one was non-negotiable.",
    fullLink: "#",
    location: { lat: 20.6296, lng: -87.0739, name: "Playa del Carmen, Mexico" },
    stayDuration: 6,
    formattedDuration: formatDuration(6)
